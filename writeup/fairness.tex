...
DAG with explicit inclusion of set $U$ and independent of background
...
person hiring is prejudiced, and one the employee's
...
algorithm will give a fair predictor using $A$ and $X$.
\end{lem}
%
\begin{proof}
...
The above result holds in a more general case for the structure given
