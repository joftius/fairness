...
\begin{center}
\vspace{-2ex}
\centerline{\includegraphics[width=\textwidth]{simple_models_no_q2}}
\vspace{-2ex}
...
ideally we would like to use to perform ecisions but which is
...
\cite{pearl:00}, we show in Figure \ref{fig:ex1}(c) that $Y_a$ and
$Y_{a'}$ are not in general identically distributed\footnote{We assume
  ...
  racially-associated names in a CV or loan application.}  given the
