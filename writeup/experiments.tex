...
appearance, % if force was used,
etc. We
consider the data collected on males stopped during 2014. % We limit our analysis to looking at just males stopped as this accounts for more than $90\%$ of the data.
