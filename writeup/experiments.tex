...
F \sim {\cal N}(w_7 K + w_8 + w_9 R + w_{10} S) \nonumber \\
P \sim \textrm{Bernoulli}
\end{align}


In this case, we make no assumptions that interactions between variables are linear or additive. 
